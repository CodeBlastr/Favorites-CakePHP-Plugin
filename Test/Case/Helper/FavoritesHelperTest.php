 ...
 */
	public function testToggleFavorite() {
		...
		$this->assertEqual($result, '<a href="/favorites/favorites/add/watch/1" class="add-favorite watch add">Watch it</a>');
	}
 ...
 */
	public function testToggleFavoriteWithRemove() {
		...
		$this->assertEqual($result, '<a href="/favorites/favorites/delete/0" class="remove-favorite watch delete">Watch it</a>');

		$result = $this->Favorites->toggleFavorite('watch', 'my-thing-id', null, 'Stop watching');
		$this->assertEqual($result, '<a href="/favorites/favorites/delete/0" class="remove-favorite watch delete">Stop watching</a>');
	}
}
